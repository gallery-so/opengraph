...
describe('/api/og/gallery/[galleryId]/fcframe', () => {
  describe('clicking Next on first token in carousel', () => {
    let response: AxiosResponse;
    let html: string;
    beforeAll(async () => {
      response = await axios.post(
        'http://localhost:3000/api/og/gallery/2QzRSthNb6PAZmnSnRvPAea9LPX/fcframe',
        {
    ...
    it('should increment the position parameter', () => {
      expect(html).toContain(
        '<meta property="fc:frame:image" content="http://localhost:3000/api/og/gallery/2QzRSthNb6PAZmnSnRvPAea9LPX/fcframe?galleryId=2QzRSthNb6PAZmnSnRvPAea9LPX&position=1">'
      );
    });
  });
  ...
  describe('clicking Next on second token', () => {
    ...
    beforeAll(async () => {
      response = await axios.post(
        'http://localhost:3000/api/og/gallery/2QzRSthNb6PAZmnSnRvPAea9LPX/fcframe?galleryId=2QzRSthNb6PAZmnSnRvPAea9LPX&position=1',
        {
    ...
    it('should increment the position parameter', () => {
      expect(html).toContain(
        '<meta property="fc:frame:image" content="http://localhost:3000/api/og/gallery/2QzRSthNb6PAZmnSnRvPAea9LPX/fcframe?galleryId=2QzRSthNb6PAZmnSnRvPAea9LPX&position=2">'
      );
    });
  });
  ...
  describe('clicking Previous on second token', () => {
    ...
    it('should not include a position parameter', () => {
      expect(html).toContain(
        '<meta property="fc:frame:image" content="http://localhost:3000/api/og/gallery/2QzRSthNb6PAZmnSnRvPAea9LPX/fcframe?galleryId=2QzRSthNb6PAZmnSnRvPAea9LPX">'
      );
    });
  });
});
